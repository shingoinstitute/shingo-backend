...
.get(function(req, res, next){
  var filename = file;
  var query = "Select Name, Date_Awarded__c, City__c, Country__c, SV_Status__c, Company_Profile_Link__c, Press_Release_Link__c, Years_Since_Awarded__c FROM Assessment__c WHERE Publish_to_Website__c=true and Date_Awarded__c != NULL ORDER BY Date_Awarded__c DESC";
